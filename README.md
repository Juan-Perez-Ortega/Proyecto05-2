...
# Proyecto 05-2: Análisis de Memoria con Volatility

Este proyecto documenta el proceso de análisis de una memoria RAM utilizando Volatility y la generación de símbolos personalizados para un kernel específico de Linux.
